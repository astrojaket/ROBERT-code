...
PAPER = {
    ...
    "model": "CHIMERA homogeneous one-region cloud-free, full 2-12 micron spectrum",
...
def _plot_paper_parameters(
    ...
    figure.suptitle("Published cloud-free-model comparison (models are not identical)")
    figure.tight_layout()
