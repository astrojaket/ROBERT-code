...
def _plot(
    ...
    ax_spectrum.plot(wavelength, picaso, color="#222222", lw=2.0, label="PICASO Toon")
    ax_spectrum.plot(wavelength, robert, color="#e45756", ls="--", lw=1.8, label="ROBERT")
    ax_spectrum.set(
    ...
    ax_residual.plot(wavelength, 100.0 * relative, color="#4c78a8")
    ...
    ax_components.plot(wavelength, robert, color="#222222", lw=2.0, label="six gases")
    ax_components.set(
