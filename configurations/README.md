...
| --- | --- | --- |
| [`quickstart.yaml`](quickstart.yaml) | Bundled R=100 emission injection recovery | The generated synthetic observation under `examples/outputs/r100_validation/emission/` |
...
| [`transmission.yaml`](transmission.yaml) | Bundled R=100 hot-Jupiter free-chemistry transmission | The generated synthetic observation under `examples/outputs/r100_validation/transmission/` |
...
the validation notebook can run without a high-resolution opacity archive.
