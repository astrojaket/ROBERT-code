...
| `EmissionForward.spectrum(...)` | clear-sky emission RT backend |
...
### Step 7: Build a NumPy Clear-Sky Emission Reference Backend
...
- Implement a simple NumPy clear-sky thermal emission backend.
...
- Clear-sky emission backend has at least one benchmark comparison.
