"""Tests for the reusable parameterized cloud-free emission model."""
...
def _model() -> EmissionForwardModel:
...
def test_emission_model_evaluates_multi_gas_eclipse_depth() -> None:
    model = _model()
...
def test_emission_model_rejects_missing_or_invalid_parameters() -> None:
    model = _model()
...
def test_emission_config_requires_species_parameter_alignment() -> None:
...
def test_emission_model_can_derive_planet_gravity() -> None:
    model = _model()
    derived = EmissionForwardModel(
